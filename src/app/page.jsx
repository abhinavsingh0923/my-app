            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                <img
                  ...
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRkBWN5dFCwEmvfZxawxNoHkwtVxZzIlfL3e04N4qqbQ&s"
                  alt="blog"
                />
                <div className="p-6 bg-white">
                  ...
                  <p className="leading-relaxed mb-3">
                    A crispy, golden-brown South Indian crepe made from
                    fermented rice and lentil batter, filled with a spiced
                    potato and onion mixture. Served with coconut chutney and
                    tangy sambar.
                  </p>
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <p className="leading-relaxed mb-3">
                    Light and fluffy pancakes packed with juicy blueberries,
                    topped with a pat of butter and a drizzle of pure maple
                    syrup. Served with a side of fresh fruit and whipped cream.
                    syrup. Served with a side of fresh fruit.
                  </p>
                  <div className="flex items-center flex-wrap">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
                      Learn More
            ...
            <div className="p-4 md:w-1/3">
              <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div className="p-6 bg-white">
                  ...
                  <p className="leading-relaxed mb-3">
                    A triple-decker sandwich layered with smoked turkey, crispy
                    bacon, fresh lettuce, ripe tomatoes, and creamy avocado.
                    Served on toasted multigrain bread with a side of house-made
                    potato chips.
                  </p>
                  <div className="flex items-center flex-wrap ">
                    <a className="text-indigo-500 inline-flex items-center md:mb-2 lg:mb-0">
